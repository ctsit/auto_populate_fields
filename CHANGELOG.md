# auto_populate_fields 2.7.0 (released 2026-06-04)
- Remove defaultWhenVisible feature broken by REDCap 15.7.0 (@pbchase, #73, #75)
- Replace helper.js with config.json action-tags declarations (@pbchase, #75)
- Replace redcap_every_page_top with targeted hooks (@pbchase, #75)
- Bump framework version to 16 and redcap-version-min to 14.6.4 (@pbchase, #75)
- Replace .zenodo.json with CITATION.cff (@pbchase, #75)
- Clarify that field names in DEFAULT-FROM-PREVIOUS-EVENT tags require quotes (@pbchase, #75)
- Remove test_branching_logic form from examples and update testing.md (@pbchase, #75)
- Add CLAUDE.md (@pbchase, #75)
- Prevent potential undefined USERID causing error (@ChemiKyle, #74)
- Prevent typerror when arm has no events (@ChemiKyle, #74)

# auto_populate_fields 2.6.5 (released 2024-09-23)
