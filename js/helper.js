$(document).ready(function() {
    ...
    $('body').on('dialogopen', function(event, ui) {
        ...
        var texts = {
            ...
            '@FIELD-NOTE-DISPLAY': 'If a field contains this action tag, then the field note is hidden form the view, and shown on hover of the field. This is useful when the filed_note is too long and it is unnecessary to show the field note all the time.'
        };
